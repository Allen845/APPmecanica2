...
import com.uvdstudio.mecanica2.databinding.ActivityMenuPrincipalBinding
...
class MenuPrincipal : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_home,R.id.nav_usuario, R.id.nav_proforma, R.id.nav_escaneo,  R.id.nav_cotizacion, R.id.nav_reclamo, R.id.nav_evidencia
            ), drawerLayout
        )
